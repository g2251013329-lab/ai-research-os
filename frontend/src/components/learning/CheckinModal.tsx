...
export default function CheckinModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className="w-[460px] max-w-[92vw] rounded-xl border border-border bg-surface p-4 shadow-2xl dark:border-border dark:bg-surface">
        ...
        <div className="mt-2.5 grid grid-cols-2 gap-2">
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="text-[12px] text-foreground/45">{t('learning.checkin.minutes')}</span>
          </div>
