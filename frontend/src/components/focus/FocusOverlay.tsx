...
export default function FocusOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-[380px] max-w-[92vw] rounded-2xl border border-neutral-200 bg-white p-6 text-center shadow-2xl dark:border-neutral-700 dark:bg-neutral-900">
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-[13px] font-medium text-neutral-500 dark:text-neutral-400">
        ...
        <div className="mt-1 text-[12px] text-neutral-400">{t('focus.currentTask')}</div>
          ...
          {remaining === null ? (
            ...
            <>
              ...
              <button
                ...
                className="rounded-md border border-neutral-300 px-4 py-2 text-[13px] transition-colors hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800"
              >
                {t('focus.finishEarly')}
              </button>
            </>
