    ...
    <div className="mx-auto max-w-6xl p-6">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-md border border-border px-3 py-1.5 text-[13px] transition-colors hover:border-accent hover:text-accent dark:border-border"
        >
      ...
      {/* tabs */}
      <div className="mt-4 flex gap-1 border-b border-border dark:border-border">
        {TABS.map((tb) => (
          <button
            key={tb}
            type="button"
      ...
      <div className="mt-4">
        ...
        {tab === 'checkin' && (
          <div>
            <p className="text-[12px] text-foreground/45">{t('learning.checkin.hint')}</p>
              ...
              {(overview?.recent_sessions ?? []).map((s) => (
                <div key={s.id} className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div data-tip={s.topic} className="truncate text-[13.5px]">
                      {s.topic}
                    </div>
