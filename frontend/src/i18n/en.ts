export default {
  ...
  ai: {
    channels: {
      ...
      claude_science: { name: 'Claude Science', tip: 'Open the Claude Science workbench', desc: 'One-click start the sandbox and open the auth page (re-auth needed after daemon restarts)', open: 'Start & Enter Claude Science', direct: 'Already logged in? Open directly', relogin: 'Session invalid? Re-login' },
